...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start rounded-lg bg-slate-100 p-1 gap-1 w-full overflow-x-auto",
      className
    )}
    {...props}
  />
